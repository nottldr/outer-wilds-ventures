...
const nodes: MapNode[] = [
  ...
  },
  {
    ...
    logs: ['A mural of a Nomai vessel encountering a signal.'],
    colour: PlanetColour.RED,
    size: MapNodeSize.XSMALL,
    connections: [],
    location: {
  ...
  },
  {
    ...
    logs: [
      ...
      'Solanum wonders what would happen if a conscious observer were to enter the Eye.',
  ...
  },
  {
    ...
    logs: [
      ...
      '* Hal says the statue has never opened its eyes before (despite Hornfels’ best efforts). [Optional for Archaeologist]',
    ],
    colour: PlanetColour.GREY,
    size: MapNodeSize.MEDIUM,
